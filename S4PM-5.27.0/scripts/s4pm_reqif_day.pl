...
s4pm_reqif_day.pl - test on whether file is a day file or not
...
The B<s4pm_reqif_day.pl> script is intended to be used with the required-if
...
"Day" or "Both", the script returns 1. Otherwise, it returns 0. 
...
################################################################################
# s4pm_reqif_day.pl,v 1.2 2006/09/12 20:31:39 sberrick Exp
